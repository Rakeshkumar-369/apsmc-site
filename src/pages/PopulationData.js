...
function PopulationData() {
  ...
  const populationPdfs = [
    { title: "Minority Population Census 2011 - Andhra Pradesh", filename: "ap-minority-census-2011.pdf" },
    { title: "Demographic Trends of Minorities (2010-2020)", filename: "demographic-trends-2010-2020.pdf" },
    { title: "District-wise Minority Population Report", filename: "district-wise-minority-report.pdf" },
    ...
    <div className="bg-apsmc-light py-20 px-6 min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-700 mb-12 text-center">
          Detailed demographic data and analysis of minority populations across Andhra Pradesh.
        </p>

        <div className="space-y-6">
          {/* Map through the list of PDFs to display each as a clickable card */}
          {populationPdfs.map((pdf, index) => (
            <div
