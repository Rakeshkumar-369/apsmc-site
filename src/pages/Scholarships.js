...
function Scholarships() {
  ...
  // Define the list of PDFs for Scholarships.
  // IMPORTANT: Ensure these filenames exactly match the PDFs you place in your public/pdfs folder.
  const scholarshipPdfs = [
    { title: "Minority Scholarship Scheme Guidelines 2024-25", filename: "scholarship-guidelines-2024-25.pdf" },
    { title: "Application Form for Pre-Matric Scholarship", filename: "pre-matric-scholarship-form.pdf" },
    { title: "Post-Matric Scholarship Eligibility Criteria", filename: "post-matric-eligibility.pdf" },
    { title: "List of Scholarship Beneficiaries (2023-24)", filename: "scholarship-beneficiaries-2023-24.pdf" }
  ];
    ...
    <div className="bg-apsmc-light py-20 px-6 min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-700 mb-12 text-center">
          Explore various scholarship opportunities and financial aid programs for minority students in Andhra Pradesh.
        </p>

        <div className="space-y-6">
          {/* Map through the list of PDFs to display each as a clickable card */}
          {scholarshipPdfs.map((pdf, index) => (
            <div
