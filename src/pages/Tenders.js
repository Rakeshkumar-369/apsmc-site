...
function Tenders() {
  ...
  // Define the list of PDFs for Tenders.
  // IMPORTANT: Ensure these filenames exactly match the PDFs you place in your public/pdfs folder.
  const tenderPdfs = [
    { title: "Tender Notice: Construction of Minority Skill Development Center", filename: "tender-skill-center-construction.pdf" },
    { title: "E-Tender for Supply of Educational Materials", filename: "e-tender-educational-materials.pdf" },
    { title: "Request for Proposal (RFP) for IT Solutions", filename: "rfp-it-solutions.pdf" },
    { title: "Corrigendum: Extension of Tender Submission Date", filename: "corrigendum-tender-extension.pdf" }
  ];
    ...
    <div className="bg-apsmc-light py-20 px-6 min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-700 mb-12 text-center">
          Browse through current and past tenders, bids, and official notices from the APSMC.
        </p>

        <div className="space-y-6">
          {/* Map through the list of PDFs to display each as a clickable card */}
          {tenderPdfs.map((pdf, index) => (
            <div
